...
const searchBar = document.getElementById('search-bar');
  ...
  function search(text) {
    ...
    console.log(createTreeData(dataThreatTotal,dataThreatType,dataFamliy,selectedWord));
    drawTreeMap(createTreeData(dataThreatTotal,dataThreatType,dataFamliy,selectedWord));
  };
